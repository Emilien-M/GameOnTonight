...
using System;
namespace GameOnTonight.RestClient.Profile
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GameOnTonight.RestClient.Profile.ProfileRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::GameOnTonight.RestClient.Models.ProfileViewModel?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GameOnTonight.RestClient.Models.ProfileViewModel> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GameOnTonight.RestClient.Profile.ProfileRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GameOnTonight.RestClient.Profile.ProfileRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GameOnTonight.RestClient.Profile.ProfileRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
